...
public class ClientWarning implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
        ...
        HudRenderCallback.EVENT.register((stack, delta) ->
        {
            ...
            MinecraftClient.getInstance().textRenderer.draw(stack, new LiteralText("§4Warning: Working Graves is a dedicated server only mod."), 2, 2, 1);
            ...
            MinecraftClient.getInstance().textRenderer.drawWithShadow(stack, new LiteralText("§frefer to https://github.com/StoneLabs/working-graves."), 2, 37, 1);
